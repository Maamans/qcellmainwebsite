            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 pt-2">
              ...
              >
                ...
                >
                  <Link
                    href="#"
                    className="inline-flex w-full sm:w-56 items-center justify-center gap-2 rounded-full bg-[#077aca] px-6 py-3 text-sm font-medium text-white transition-all hover:bg-[#077aca]/90 whitespace-nowrap"
                  >
              ...
              >
                ...
                >
                  <Link
                    href="#"
                    className="inline-flex w-full sm:w-56 items-center justify-center gap-2 rounded-full bg-[#F98F1F] px-6 py-3 text-sm font-medium text-white transition-all hover:bg-[#F98F1F]/90 whitespace-nowrap"
                  >
                    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
