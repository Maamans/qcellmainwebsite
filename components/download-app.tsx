...
export default function DownloadApp() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="container relative mx-auto px-3 sm:px-4 md:px-6"
        variants={containerVariants}
        initial="hidden"
        animate={isInView ? "visible" : "hidden"}
      >
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 lg:gap-16 items-start md:items-center">
          <div className="space-y-8">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-2">
              <motion.div
                className="flex-1 flex flex-col items-start sm:items-center"
              ...
              >
                ...
                >
                  <Link
                    href="#"
                    className="inline-flex w-56 items-center justify-center gap-2 rounded-full bg-[#077aca] px-6 py-3 text-sm font-medium text-white transition-all hover:bg-[#077aca]/90 whitespace-nowrap"
                  >
              ...
              >
                ...
                >
                  <Link
                    href="#"
                    className="inline-flex w-56 items-center justify-center gap-2 rounded-full bg-[#F98F1F] px-6 py-3 text-sm font-medium text-white transition-all hover:bg-[#F98F1F]/90 whitespace-nowrap"
                  >
                    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
