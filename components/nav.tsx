...
const navItems: NavItem[] = [
    ...
    },
    {
        title: "Tariffs",
        content: {
        heading: "Flexible Tariff Plans for Everyone.",
        subheading: "Choose the best plan for your needs and budget.",
        links: [
            { title: "Data Bundles", href: "/tariffs/data-bundles" },
            { title: "Voice Tariffs", href: "/tariffs/voice-tariffs" },
        ],
        },
        href: '/tariffs',
    },
                      ...
                      <Link href={item.href ? item.href : "#"}>
                        ...
                        >
                          <span className="relative">
                            {item.title}
                            {item.title !== "Promotions" && activeItem === item.title && (
                              <motion.div
                          ...
                          {/* Only show dropdown chevron if item has dropdown content and is not Promotions */}
                          {item.content && item.title !== "Promotions" && (
                            <motion.div
                              animate={{
